  ...
  return (
    <Container className="about">
      ...
      <div className="aboutStory">
        <p>
          I’ve always sought out opportunities and challenges in my life. Raise
          and born in The Philippines, studied nursing school in college at the
          same time doing free lance graphic design work online and learning how
          to code.
        </p>
